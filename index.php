...
else if ($mobileLayout) $mobileswitch .= '<a href="?forcelayout=-1" rel="nofollow">Enable normal view</a>';
else $mobileswitch .= '<a href="?forcelayout=1" rel="nofollow">Enable mobile view</a>';
...
<html>
<br />
Powered by <a href="http://abxd.dirbaio.net/">AcmlmGoBlarga</a> v1.0 <i>Super Development</i><br />
Based off of AcmlmBoard v2.5, ABXD3 and Blargboard with changes made by theninja1000 <a href="?page=credits">et al</a><br />
&copy; ABGB v1.0<br />
...
<a href="?page=rss">
    <img src="img/rss.png" alt="Uses RSS 2.0!" />
</a><br />
<a href="http://board.kafuka.org">
     <img src="img/poweredbyacmlm.png" alt="Runs on AcmlmBoard!" />
</a><br>
<form><select onchange=window.open(this.options[this.selectedIndex].value)>
               <OPTION selected>Forum affiliates:
// just type <Option value=urlgoeshere>textgoeshere
<Option value=http://google.com>egf
       </select></form></html>
<?php
...
<?php 
	if (Settings::get('maintenance'))
		echo '<div style="font-size:30px; font-weight:bold; color:red; background:black; padding:5px; border:2px solid red; position:absolute; top:30px; left:30px;">Maintenance Mode is enabled.</div>';
