...
if(!$user)
	kill("This user was not found. Please check the User ID in the address bar. Add &id=X and replace X with the user's ID.");

if($user["powerlevel"] > 0)
	kill("You can't delete a staff member. Demote him first.");
...
echo "
<form name=\"confirmform\" action=\"".actionLink("deluser", $uid)."\" method=\"post\">
	<table class=\"outline margin width50\">
		...
		<tr class=\"cell2\">
			<td></td>
			<td>
				<input type=\"submit\" name=\"actionlogin\" value=\"".__("Force delete!")."\" />
			</td>
		</tr>
	</table>
</form>";
