...
CheckPermission('admin.viewdashboard');
...
if (HasPermission('admin.editsettings')) $adminConfig[] = actionLinkTag(__("<button>General Settings</button>"), "editsettings");
...
if (HasPermission('admin.editsettings'))
{
	...
	$adminConfig[] = actionLinkTag(__("<button>Assign Badges</button>"), "addbadges");
}
...
if (HasPermission('admin.badges'))       $adminTools[] = actionLinkTag(__("<button>Badge Management</button>"), "badges");
