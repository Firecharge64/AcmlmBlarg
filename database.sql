/* 
 AcmlmBlarg data set
 If you have no SQL knowledge, please do
 not play with these before installing your board.
 It could result in the board installing improperly.
*/
...
(1, 'Announcements', 'Stuff you should read that is very important.', 1, 0, 0, 0, 0, 0, 0, 0, '', 1, 2, '', 0);
(2, 'General Chat', 'Topics of all kinds..', 1, 0, 0, 0, 0, 0, 0, 0, '', 1, 2, '', 0);
(3, 'Site Bugs & Suggestions', 'Have you got an issue? Let us know here!', 1, 0, 0, 0, 0, 0, 0, 0, '', 1, 2, '', 0);
(4, 'Relaxing Island', 'The best place in town to have some waffles!', 2, 0, 0, 0, 0, 0, 0, 0, '', 1, 2, '', 0);
(5, 'Staff Room', 'Staff chat, no normals or bans allowed here. Just staff.', 2, 0, 0, 0, 0, 0, 1, 0, '', 1, 2, '', 0);
(3, 'Trash', 'Eww, it stinks in here. Do not come in, unless you want to smell something stinky.', 3, 0, 0, 0, 0, 0, 0, 0, '', 1, 2, '', 0);
(3, 'Hidden Trash', 'The worst of trash. Only staff can see it.', 3, 0, 0, 0, 0, 0, 1, 0, '', 1, 2, '', 0);
...
(0, 4, 'admin.delusers', 0, 1);

INSERT INTO `{$dbpref}settings` (`plugin`, `name`, `value`) VALUES
('main', 'boardname', 'Acmlmblarg'),
('main', 'metaDescription', 'Acmlmblarg, Blargboard, but Acmlmified. '),
('main', 'metaTags', 'acmlm board acmlmboard acmlmblarg blargboard blarg board'),
('main', 'dateformat', 'd-m-y, h:i a'),
...
('main', 'breadcrumbsMainName', 'Acmlmblarg'),
('main', 'mailResetSender', ''),
('main', 'defaultTheme', 'Acmlmblarg_Default'),
('main', 'disreg', ''),
('main', 'defaultLayout', 'abxd'),
('main', 'defaultLanguage', 'en_GB'),
('main', 'showPoRA', '0'),
('main', 'tagsDirection', 'Left'),
('main', 'PoRATitle', 'Acmlmified Box'),
('main', 'PoRAText', 'Welcome to Acmlmblarg. Edit this message in your forum settings or you can simply disable me.'),
('main', 'profilePreviewText', 'This is a sample post. It [b]tests[/b] your [u]post layout[/u] against a variety of forum markup.<br>[quote=someone]The quick brown fox jumps over the lazy dog.</a></div></div><br>What do you <a href="http://en.wikipedia.org">want to know otherwise?</a>'),
('main', 'menuMainName', 'Acmlmblarg'),
('main', 'showGender', '1'),
('main', 'nofollow', '0'),
